...
type DictionaryService interface {
	GetDictionaries(ctx context.Context, in *GetDictionariesRequest, opts ...client.CallOption) (*GetDictionariesResponse, error)
}
...
func (c *dictionaryService) GetDictionaries(ctx context.Context, in *GetDictionariesRequest, opts ...client.CallOption) (*GetDictionariesResponse, error) {
	req := c.c.NewRequest(c.name, "DictionaryService.GetDictionaries", in)
...
func RegisterDictionaryServiceHandler(s server.Server, hdlr DictionaryServiceHandler, opts ...server.HandlerOption) error {
	type dictionaryService interface {
		GetDictionaries(ctx context.Context, in *GetDictionariesRequest, out *GetDictionariesResponse) error
	}
	type DictionaryService struct {
		dictionaryService
	}
...
func (h *dictionaryServiceHandler) GetDictionaries(ctx context.Context, in *GetDictionariesRequest, out *GetDictionariesResponse) error {
	return h.DictionaryServiceHandler.GetDictionaries(ctx, in, out)
}
